...
- **Current task:** 3 — `lib/validate.ts`, constraints
...
| 2 | `lib/validate.ts` — structure: `type`, `properties`, `required`, `additionalProperties`, and the **unknown-keyword refusal** | — | T-01, T-02, T-03, T-04, T-11, T-12 | 1 | `done` | 1/3 | `pending` |
